 ...
 * (which can be negative) The 'alt_random' parameter is used (if > 0) for
 * testing the function by supplying a known "random" value */

double tlt_grow_leaf(struct rnode *, double, double alt_random);
