/* node_pos_alloc.h: functions for allocating node's positions. Used
 ...
 * using callback functions. The advantage of this is that the functions do not
 * need to know how this data is stored (it may be stored in a struct
