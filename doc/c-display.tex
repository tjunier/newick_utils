...
\starttabulate[|c|c|]
	\NC A \NC B \NC\NR
	\NC C \NC D \NC\NR
%	\NC \typefile{display_21_txt.cmd} \typefile{display_21_txt.out}
%	\NC \typefile{display_22_txt.cmd} \typefile{display_22_txt.out} \NC\NR
%	\NC \typefile{display_23_txt.cmd} \typefile{display_23_txt.out} 
%	\NC \typefile{display_24_txt.cmd} \includegraphics[width=0.5\textwidth]{display_24_txt.png}
%This is a screenshot because I don't know how to show VT100 special characters in \LaTeX{} :-) \NC\NR
\stoptabulate
}
