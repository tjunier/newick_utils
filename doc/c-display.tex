...
\begin{center}
\begin{tabular}{cl}
Argument to \code{-e} & Effect \\
\hline 
\code{r} & (raw) use just \type{|}, \type{-}, and \type{+}, and \type{=} for the root. \\
\code{c} & (commas) corners are marked with \type{'} and \type{,} \\
\code{s} & (slashes) corners are marked with \type{/} and \type{\textbackslash} \\
\code{v} & (VT100) use VT100 pseudo-graphical characters
\end{tabular}
\end{center}
