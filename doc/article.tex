...
For example, suppose we produced a set of around 1,000 maximum-likelihood trees
...
multivariate analysis. Since ML trees are not rooted, we must first root all the
trees, in this case on \textit{Danio} and \textit{Fugu}. This can be done with
