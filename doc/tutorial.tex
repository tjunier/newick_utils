...
\section{The Newick Format}
\label{sct_newick}

The Newick format is a file format for (phylogenetic) trees. It is one of the most widely used and uderstood formats.
...
Since the \nutils{} are for working with trees, it should not be a surprise that all programs accept Newick as input.
