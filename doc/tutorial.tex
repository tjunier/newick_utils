...
\begin{center}
 \includegraphics{catarrhini.pdf}
 % catarrhini.pdf: 595x842 pixel, 72dpi, 20.99x29.70 cm, bb=0 0 595 842
\end{center}
...
\begin{center}
 \includegraphics{catarrhini_radial.pdf}
 % catarrhini_radial.pdf: 595x842 pixel, 72dpi, 20.99x29.70 cm, bb=0 0 595 842
\end{center}
