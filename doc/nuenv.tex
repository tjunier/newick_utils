...
\useURL[URL:CMake][http://www.cmake.org]
...
\useURL[URL:XCode][developer.apple.com/tools/xcode]
...
\definedescription[glossaryentry][headstyle=bold, style=normal, align=left, location=hanging, width=broad, margin=1cm]
