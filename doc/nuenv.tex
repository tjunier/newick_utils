...
%
\setupurl[style=type]
% \useURL[ensembl][http://www.ensembl.org/index.html]
% \useURL[viralzone][http://expasy.org/viralzone]
% \useURL[ictvdb][http://www.ictvdb.org]
% \useURL[cdc-non-polio][http://www.cdc.gov/ncidod/dvrd/revb/enterovirus/non-polio_entero.htm]
\useURL[newick-format][http://evolution.genetics.washington.edu/phylip/newicktree.html]
% \useURL[ToL][http://www.tolweb.org]
% \useURL[GOLD][http://genomesonline.org/gold\_statistics.htm]
% \useURL[unit-tests][http://www.extremeprogramming.org/rules/unittests.html]
% \useURL[XP][http://www.extremeprogramming.org/index.html]
% \useURL[vista][http://genome.lbl.gov/vista/index.shtml]
% \useURL[ecr][http://ecrbrowser.dcode.org/]
% \useURL[ucsc][http://genome.ucsc.edu/]
% \useURL[GOTM][http://bioinfo.vanderbilt.edu/webgestalt/]
