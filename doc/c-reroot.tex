...
done by passing option \texttt{-l} ("lax"), along with {\em all} species in
the outgroup (this is because \reroot{} finds the ingroup by complementing the
outgroup):

\typefile{reroot_7_svg.cmd}
\startalignment[center]
\externalfigure[reroot_7_svg]
\stopalignment
...
\startalignment[center]
\externalfigure[reroot_10_svg]
\stopalignment

As it happens, rerooting on the longest branch gets it right:

\typefile{reroot_11_svg.cmd}
\startalignment[center]
\externalfigure[reroot_11_svg]
\stopalignment
...
\startalignment[center]
\externalfigure[reroot_8_svg]
\stopalignment

\noindent{}we can deroot it thus:

\typefile{reroot_9_svg.cmd}
\startalignment[center]
\externalfigure[reroot_9_svg]
\stopalignment
