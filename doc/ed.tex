...
current functions (table \ref{tbl:luaedPredefFunc}), and you can of course use
any arbitrary Lua code -- you can even write your own functions (this is most
...
\begin{table}
	...
	\caption{%
		...
		when passing the action on the command line.
	}
\end{table}
...
\texttt{N.par}; doubling its length would be \texttt{N.par.len = N.par.len * 2}.
